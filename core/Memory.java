 ...
 * Memory.java
 *
 * This class models the main memory of a computer, with 64-bit elements (that is 8 byte). (c) 2006
 * Salvatore Scellato, Andrea Spadaccini
 *
...
/**
 * This class models the main memory of a computer, with 64-bit elements (that is 8 byte). The
 * Memory is composed of MemoryElement and its size is not limited.
 */
public class Memory {
	// cancellabile?
	 ...
	 * returns the unique allowed instance of Memory, thus subsequent calls of this method will return
	...
	/**
	 * Returns the MemoryElement at given address. Please note that an index is not an address, for
	 * addresses must be aligned to 8 byte and indexes do not.
	 * 
	 ...
	 */
	public Instruction getInstruction(BitSet64 address)
			throws HaltException, IrregularStringOfBitsException {
		try {
