 ...
 * XORI.java
 *
 * 22th may 2006 Instruction SLTI of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia
...
class XORI extends ALU_IType {
    ...
    // since this operation is carried out with zero padding of the immediate, //against
    // sign_extend(immediate) methodology
    // of all others instructions in the same category, it is necessary the overriding of the ID
    // method
    public void ID()
