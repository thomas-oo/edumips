 ...
 * Loading.java
 *
 * 26th may 2006 Subclass of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia Massimo,
 * Russo Daniele
 *
...
public abstract class Loading extends LDSTInstructions {
    ...
    public void ID() throws RAWException, IrregularWriteOperationException,
            IrregularStringOfBitsException, TwosComplementSumException {
    ...
    public void doWB() throws IrregularStringOfBitsException {
        // passing memory value from temporary LMD register to the destination register and
        // unlocking it
    ...
    public static void main(String args[]) {
        try {
            ...
            inst.params.add(1);
            inst.params.add(4); // offset // (OFFSET+BASE) OCCHIO ALL'ALLINEAMENTO A SECONDA DEL
                                // TIPO DI ISTRUZIONE USATA
