 ...
 * ALU_RType.java
 *
 * 5th may 2006 Subgroup of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia Massimo,
 * Russo Daniele
 *
...
public abstract class ALU_RType extends ALUInstructions {
    ...
    public void ID()
        ...
        logger.info("RD is R" + params.get(RD_FIELD) + "; RS is R" + params.get(RS_FIELD)
                + "; RT is R" + params.get(RT_FIELD) + ";");
        ...
        logger.info("RD = " + TR[RD_FIELD].getValue() + "; RS = " + TR[RS_FIELD].getValue()
                + "; RT = " + TR[RT_FIELD].getValue() + ";");
    }

    public void EX() throws IrregularStringOfBitsException, IntegerOverflowException,
            TwosComplementSumException, IrregularWriteOperationException, DivisionByZeroException {
    }
    ...
    public void pack() throws IrregularStringOfBitsException {
        // conversion of instruction parameters of "params" list to the "repr" form (32 binary
        // value)
