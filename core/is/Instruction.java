...
public abstract class Instruction {
    ...
    protected static boolean partial = true;
    ...
    public abstract void EX() throws HaltException, IrregularStringOfBitsException,
            IntegerOverflowException, TwosComplementSumException, IrregularWriteOperationException,
     ...
     * </pre>
     **/
    public abstract void MEM() throws HaltException, IrregularStringOfBitsException,
            MemoryElementNotFoundException, AddressErrorException, IrregularWriteOperationException;
    ...
    /**
     * <pre>
     * Sets the instruction with a list of parameters Passed list | Instruction to set e.g. list= {
     * 1, 2, 3} | DADD R1,R2,R3 list= { 1, address memory corresponding with var, 0} | LD R1,
     * var(R0)
     * 
    ...
    /**
     * Sets the comment of the instruction as string. The comment is the text after every semicolon
     * in the file .s
     * 
    ...
    /**
     * Gets the comment of the instruction as string.The comment is the text after every semicolon
     * in the file .s
     * 
     * @return the comment
     */
    ...
    /**
     * Gets the state of EnableForwarding. This modality anticipates writing on registers at EX
     * stage for Alu instructions or at MEM stage for Load-Store instructions
     * 
