 ...
 * JAL.java
 *
 * 20th may 2006 Instruction JAL of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia
...
public class JAL extends FlowControl_JType {
    ...
    public void ID() throws RAWException, IrregularWriteOperationException,
            IrregularStringOfBitsException, JumpException {
        ...
        // appending the 35 most significant bits of the program counter on the left of
        // "instr_index"
    ...
    public void EX() throws IrregularStringOfBitsException, IntegerOverflowException,
            IrregularWriteOperationException {
    }
