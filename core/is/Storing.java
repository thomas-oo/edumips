 ...
 * Storing.java
 *
 * 22th may 2006 Exception of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia
...
public class Storing extends LDSTInstructions {
    ...
    public void ID() throws RAWException, IrregularWriteOperationException,
        ...
        // if the base register and the rt register are valid passing value of rt register into a
        // temporary register
