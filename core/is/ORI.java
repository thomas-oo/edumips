 ...
 * ORI.java
 *
 * 22th may 2006 Instruction ORI of the MIPS64 Instruction Set (c) 2006 EduMips64 project - Trubia
...
class ORI extends ALU_IType {
    ...
    // since this operation is carried out with zero padding of immediate, against
