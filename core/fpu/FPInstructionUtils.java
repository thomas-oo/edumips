 ...
 *
 * 6th may, 2007 (c) 2006 EduMips64 project - Trubia Massimo
 *
...
public class FPInstructionUtils {
	public static void main(String[] args)
			throws FPExponentTooLargeException, FPOverflowException, FPUnderflowException {
		// System.out.println(doubleToBin("1.9406564584124654417656879286821E324345",false));
	}

	/**
	 * Converts a double value passed as string to a 64 bit binary string according with IEEE754
	 * standard for double precision floating point numbers
	 * 
	 * @param value            the double value in the format "123.213" or "1.23213E2" value belongs
	 *                         to
	 *                         [-1.797693134862315708145274237317E308,-4.9406564584124654417656879286822E-324]
	 *                         U [4.9406564584124654417656879286822E-324,
	 *                         1.797693134862315708145274237317E308]
	 * @param exceptionEnabled if this boolean is true
	 *                         ExponentTooLargeException,FPOverflowException,FPUnderflowException may
	 *                         happen
	 * @throw ExponentTooLargeException,FPOverflowException,FPUnderflowException
	 * @return the binary string
	 */
	public static String doubleToBin(String value, boolean exceptionEnabled)
			throws FPExponentTooLargeException, FPOverflowException, FPUnderflowException {
		...
		try // Check if the exponent is not in signed 32 bit, in this case the NumberFormatException
				// occurs
		{
	...
	/**
	 * In order to create a 64 bit binary string, the zero-padding on the left of the value is carried
	 * out
	 * 
	...
	/*
	 * public static String doubleToHex(double value) { return
