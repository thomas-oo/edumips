 ...
 * GUIStatistics.java
 *
 * This class shows the statistics (c) 2006 Alessandro Nicolosi
 *
...
public class GUIStatistics extends GUIComponent {
	...
	StatPanel statPanel;
	private int nCycles, nInstructions, rawStalls, structuralStalls, codeSize;
	private float cpi;
	...
	class StatPanel extends JPanel {
		JList statList;
		String[] statistics = {" Execution", " 0 Cycles", " 0 Instructions", " ", " ", " ", " Stalls",
				" 0 RAW Stalls", " 0 WAW Stalls", " 0 WAR Stalls", " 0 Structural Stalls",
				" 0 Branch Taken Stalls", " 0 Branch Misprediction Stalls", " ", " Code Size", " 0 Bytes"};
	...
	public void update() {
		...
		structuralStalls = cpu.getStructualStalls();
		...
		public Component getListCellRendererComponent(JList list, Object value, int index,
			...
			switch (index) {
				...
				case 9:
					...
					return label;
				case 10:
					label.setText(" " + structuralStalls + " " + CurrentLocale.getString("STRUCTS"));
					label.setFont(f);
					return label;
				case 11:
